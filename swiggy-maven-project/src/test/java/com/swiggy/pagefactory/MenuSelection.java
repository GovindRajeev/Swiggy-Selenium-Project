...
//	WebElement secondDishitem;
	@FindBy(xpath = "( (//div[@data-testid='normal-dish-item'])[2]//button[div[contains(text(),'Add')]])[2]")
	WebElement secondDishitem;
...
//	@FindBy(xpath = "//button[contains(@class, 'sc-jlGgGc')]//div[text()='2']") WebElement addOnemoreItem;
	...
	@FindBy(xpath = "(//div[@data-testid='normal-dish-item'])[2]//button[div[text() = '+']]")
	WebElement addOnemoreItem;

	// @FindBy(xpath = "//button[@id='view-cart-btn']//span[text()='View Cart']")
//	WebElement viewCart;

	@FindBy(xpath = "//button[@id='view-cart-btn']")
	WebElement viewCart;
